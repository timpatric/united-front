...
class AgentManagementController extends Controller
{
    ...
    public function edit(Request $request,$agent_id)
    {
        ...
        DB::update('update agents set agent_name=?, gender=?, district_name=?, agent_sign=?, role=?,reg_date=? where agent_id = ?',[$agent_name, $gender, $district_name, $agent_sign, $role, $reg_date, $agent_id]);

...
class DistrictManagementController extends Controller
{
    ...
    // }
     ...
     // */
    public function edit(Request $request, $district_id)
    {
        $district_code = $request->input('district_code'); ;
        $district_name = $request->input('district_name'); 
        DB::update('update districts set district_code=?, district_name=?',[$district_code, $district_name]);
    ...
    {
        //
        DB::delete('delete from districts where district_id = ?',[$district_id]); 
        return redirect()->route('district-management.index')->with('success','District deleted');

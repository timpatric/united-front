...
<script src="{{ asset ("/bower_components/dist/js/app.min.js") }}" type="text/javascript"></script>
    ...
    <!-- Bootstrap 3.3.2 JS -->
    <script src="{{ asset ("/bower_components/bootstrap/js/bootstrap.min.js") }}" type="text/javascript"></script>  <!--- the calender --> -->
    ...
    <!-- REQUIRED JS SCRIPTS -->
    <!-- jQuery 2.1.3 -->
    <!-- <script src="{{ asset ("/bower_components/plugins/jQuery/jquery-2.2.3.min.js") }}"></script>     <!--- the calender --> -->

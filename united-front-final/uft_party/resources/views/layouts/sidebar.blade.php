  ...
  <aside class="main-sidebar">
    ...
    <div style="">
      <ul class="sidebar-menu">
        <li class="#"><a href="{{ url('dashboard') }}"><i class="fa fa-tachometer" aria-hidden="true"></i> <span>Dashboard</span></a></li>
        <li><a href="{{ url('district-management') }}"><i class="fa fa-map-marker" aria-hidden="true"></i> <span>Districts</span></a></li>
        ...
        <li><a href="{{url('hierachy')}}"><i class="fa fa-list" aria-hidden="true"></i> <span>Hierachy</span></a></li>

  ...
  <aside class="main-sidebar">
    ...
    <div style="">
      <ul class="sidebar-menu">
        ...
        <li><a href="<?php echo e(url('hierachy')); ?>"><i class="fa fa-line-chart" aria-hidden="true"></i> <span>Hierachy</span></a></li>
      </ul>
    </div>
    </section>
  </aside>
<?php /**PATH /home/nmj/Desktop/groupWork/uft_party (copy)/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>
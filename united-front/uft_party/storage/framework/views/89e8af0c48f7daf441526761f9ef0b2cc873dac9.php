  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4" style="float:right">
          <a class="btn btn-primary" href="<?php echo e(route('treasury-management.create')); ?>">Register new fund </a>
        </div>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
...
<?php echo $__env->make('treasury_mgt.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nmj/Desktop/groupWork/uft_party (copy)/resources/views/treasury_mgt/index.blade.php ENDPATH**/ ?>
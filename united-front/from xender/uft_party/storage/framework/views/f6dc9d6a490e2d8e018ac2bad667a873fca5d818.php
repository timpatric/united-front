        ...
        <div class="col-md-4" style="margin-bottom: 30px">
          <form method="get" action="<?php echo e(route('salary-management.index')); ?>">
            ...
            <?php if (! ( $total_fund >= 2000000)): ?>
             ...
             <?php else: ?>
              <span class="input-group-prepend">
                <button type="submit" class="btn btn-secondary">Distribute the funds</button>        
             </span>
             <?php endif; ?>
...
<?php echo $__env->make('treasury_mgt.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nmj/Desktop/groupWork/3pm july 30/uft_party/resources/views/treasury_mgt/index.blade.php ENDPATH**/ ?>